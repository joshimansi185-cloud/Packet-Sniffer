...
Python 3.7+ Scapy (for packet capturing and analysis) Installation Clone the repository:

bash Copy code git clone https://github.com/Godfathxx/Packet-Sniffer.git cd packet-sniffer Install dependencies:

bash Copy code pip install scapy Running the Packet Sniffer

Start Packet Capturing Run the following command to start capturing packets from the default network interface:
go Copy code
...
Acknowledgments Scapy - For packet capturing and analysis. Network Analysis - General concepts and techniques used in network analysis.
